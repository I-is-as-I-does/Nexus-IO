...
function toggleUnseen(viewlk, state) {
  ...
  } else if ((0,_shared_NxState_js__WEBPACK_IMPORTED_MODULE_1__.isStateUnseen)(state)) {
...
function authorHandle(state, update = false) {
  var hnd = (0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.getElm)("SPAN", "nx-handle");
  if(state.srcData){
...
function authorUrl(state, update = false) {
  ...
  var authorlksp = (0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.getElm)("SPAN","nx-author-url");
 
  var urlBrck = [];
  ["[", "]"].forEach((bracket) => {
    var brsp = (0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.getElm)("SPAN", "nx-author-url-brackets");
    brsp.textContent = bracket;
    urlBrck.push(brsp);
  });
  var urla = (0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.getElm)("A", "nx-external-link");
  urla.target = "_blank";
  var hrf = '';
  if(state.srcData){
...
function setToggleUnseen(viewlk, state) {
  viewlk.append((0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.getElm)("SPAN", "nx-new-tag"));
  toggleUnseen(viewlk, state);
 (0,_shared_NxState_js__WEBPACK_IMPORTED_MODULE_1__.registerUpdateEvt)(function () {
    toggleUnseen(viewlk, state);
  });
}
...
function viewLink(state, update = false) {
  ...
  viewlk.addEventListener("click", () => {
    ...
    (0,_shared_NxState_js__WEBPACK_IMPORTED_MODULE_1__.triggerUpdate)(state);
  });
  return viewlk;
}

function authorIndexLink(state, update = false) {
  var auth = (0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.getElm)("A", "nx-author-link");
...
function readerElms(seed){
    ...
    return (0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.instanceWrap)((0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.appHeader)(), [(0,_shared_NxCommons_js__WEBPACK_IMPORTED_MODULE_2__.serviceWrap)
...
function setLinkedItems(dataUrl, threadData) {
  ...
  for(let [url, ids] of Object.entries(store.instances)){
    var prc = (0,_shared_NxState_js__WEBPACK_IMPORTED_MODULE_2__.resolveState)(url, '/', true).then((distantState) => {
...
const appDefaultCss = 'https://cdn.jsdelivr.net/gh/I-is-as-I-does/Nexus@latest/dist/css/NxIO.min.css'
const legacyDefaultCss = ['https://cdn.jsdelivr.net/gh/I-is-as-I-does/Nexus@latest/dist/css/NexusI.min.css']
...
function init(){
    (0,_i_is_as_i_does_nexus_core_src_load_NxInit_js__WEBPACK_IMPORTED_MODULE_0__.initAll)({appDefaultLang: 'en', appDefaultCss: _NxCdn_js__WEBPACK_IMPORTED_MODULE_8__.appDefaultCss, appDefaultCssAliases: _NxCdn_js__WEBPACK_IMPORTED_MODULE_8__.legacyDefaultCss}).then(seed => {
