"use strict";
(self["webpackChunknexus_io"] = self["webpackChunknexus_io"] || []).push([["NxIOView"],{
    ...
    threadData.linked.forEach((url) => {
      if(url){
        var extract = (0,_i_is_as_i_does_nexus_core_src_validt_NxStamper_js__WEBPACK_IMPORTED_MODULE_7__.splitUrlAndId)(url);
         var prc = (0,_shared_NxState_js__WEBPACK_IMPORTED_MODULE_2__.resolveState)(extract.url, extract.id).then((distantState) => {
...
//# sourceMappingURL=NxIOView.js.map